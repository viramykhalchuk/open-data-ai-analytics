...
1. Які марки автомобілів найчастіше зустрічаються у вибірці даних?
2. Які типи пального є найпоширенішими серед транспортних засобів?
3. Чи існує зв’язок між вантажопідйомністю, власною масою та повною масою транспортного засобу?
